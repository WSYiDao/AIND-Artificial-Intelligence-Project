...
class PlanningGraph():
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        if (self.is_effect(node_a1.action.effect_add,node_a2.action.effect_rem) 
         or self.is_effect(node_a1.action.effect_rem,node_a2.action.effect_add)):
            return True
        return False
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        if (   self.is_effect(node_a1.action.effect_add,node_a2.action.precond_neg) 
            or self.is_effect(node_a2.action.effect_add,node_a1.action.precond_neg) 
            or self.is_effect(node_a1.action.effect_rem,node_a2.action.precond_pos) 
            or self.is_effect(node_a2.action.effect_rem,node_a1.action.precond_pos)):
            return True
        return False
