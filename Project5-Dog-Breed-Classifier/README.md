...
- Project base on https://github.com/udacity/dog-project.git
- Includes the solution `dog_app_mywork.ipynb`, reviews `Udacity Rerviews_n`, images `*.jpeg` and `*.png` from Google.
